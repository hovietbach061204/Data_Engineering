...
DECLARE @EndDate DATETIME = '01/01/2028' --End Value of Date Range
...
/* Populate Your dboension Table with values*/
...
/*Update HOLIDAY Field of USA In dboension*/
    ...
    (
        ...
        WHERE
            [Week] = 1
    END
    --set flag for USA holidays in dboension
    UPDATE [dbo].[DimDate]
...
/* Add Fiscal Calendar columns into table dboDate */
